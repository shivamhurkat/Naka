-- =============================================================================
-- Naka — seed.sql
-- Inserts demo data for development. Run AFTER 0001_init.sql.
...
BEGIN
  ...
  -- ── Demo mill ──────────────────────────────────────────────────────────────
  INSERT INTO mills (name, owner_name, phone, address, city, state, industry)
  VALUES (
  ...
  RAISE NOTICE 'Seed complete. Mill ID: %', v_mill_id;
END $$;
